      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl font-bold text-gray-900 mt-2 mb-6">Our Story & Mission</h2>
            <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
              <p>
                Founded in 2018, NovaSoft Digital Solutions began with a simple vision: to bridge the gap between complex technology and business growth. We started as a small team of passionate developers and have grown into a full-service digital agency.
              </p>
              <p>
