    ...
    <section id="pricing" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mt-2">Choose Your Package</h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {PRICING.map((pkg, index) => (
            <motion.div
              ...
              className={`p-8 rounded-3xl bg-white border relative ${pkg.recommended ? 'border-indigo-600 shadow-xl scale-105 z-10' : 'border-gray-100 shadow-sm'}`}
            >
              {pkg.recommended && (
    ...
    <section className="py-24 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mt-2">Common Questions</h2>
        </div>
