      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="#contact"
              className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-4 rounded-full text-lg font-semibold transition-all flex items-center gap-2"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          {INDUSTRIES.map((industry, index) => (
            ...
            >
              <div className="w-20 h-20 bg-white/10 rounded-full flex items-center justify-center border border-white/20 group-hover:bg-white group-hover:text-indigo-900 transition-all duration-300">
                <CheckCircle2 size={32} />
              </div>
              <span className="font-semibold text-center">{industry}</span>
            </motion.div>
          ))}
        </div>
      </div>
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mt-2">Our Proven Process</h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 relative">
          ...
          {PROCESS.map((step, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: index * 0.1 }}
              className="relative z-10 bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all"
            >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {TESTIMONIALS.map((testimonial, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: index * 0.1 }}
              className="bg-gray-50 p-10 rounded-3xl relative"
            >
              <Quote className="absolute top-8 right-8 text-indigo-200" size={48} />
              <p className="text-xl text-gray-700 italic mb-8 relative z-10">"{testimonial.content}"</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
          <div>
            ...
            <h2 className="text-4xl font-bold text-gray-900 mt-2">Latest from Our Blog</h2>
          </div>
    ...
    <section className="py-24 bg-indigo-600 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center text-white">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="#contact"
            className="bg-white text-indigo-600 px-8 py-4 rounded-full text-lg font-bold hover:bg-indigo-50 transition-all shadow-xl"
          >
            Request a Free Consultation
          </a>
          <a
            href="#pricing"
            className="bg-indigo-500 text-white border border-indigo-400 px-8 py-4 rounded-full text-lg font-bold hover:bg-indigo-400 transition-all"
          >
            Get a Quote
          </a>
        </div>
